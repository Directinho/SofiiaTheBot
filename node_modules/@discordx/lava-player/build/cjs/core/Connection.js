...
const backoff_1 = tslib_1.__importDefault(require("backoff"));
...
class Connection {
    ...
    resumeKey;
    ws;
    reconnectTimeout = 100; // TODO: remove in next major version
    _backoff;
    _listeners = {
        close: (code, reason) => {
    ...
    constructor(node, url, options = {}) {
        ...
        this.backoff = backoff_1.default.exponential();
    ...
    connect() {
        ...
        this.ws = new ws_1.default(this.url, Object.assign({ headers }, this.options));
    ...
    close(code, data) {
        ...
        return new Promise((resolve) => {
            this.ws.once("close", (codex, reason) => {
